...
export default function StudentDashboard() {
  ...
  // ASOSIY MENYULAR (Sahifa boshqaruvi)
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-10">
      ...
      {/* TEPADA PAYDO BO'LADIGAN VAQTINCHALIK NAVIGATSIYA TUGMALARI */}
      {/* Diqqat: Asosiy sidebardagi yozuvlarni bosganingizda shu state larni ulash kerak. Hozircha bu yerdan o'tib turamiz */}
