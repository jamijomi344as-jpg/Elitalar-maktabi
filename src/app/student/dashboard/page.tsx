...
import { Info, User, GraduationCap, Award, TrendingUp, Calendar, BellRing, Activity } from "lucide-react";
...
export default function StudentDashboard() {
  ...
  return (
    <div className="w-full space-y-6 animate-in fade-in duration-500 pb-10">
      ...
      {/* TEPADAGI PROFIL */}
      <div className="bg-gradient-to-br from-blue-900 to-indigo-900 dark:from-slate-800 dark:to-slate-900 rounded-3xl p-8 text-white shadow-xl relative overflow-hidden w-full">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-6 w-full">
          ...
          <div className="flex gap-4">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 min-w-[120px] text-center">
