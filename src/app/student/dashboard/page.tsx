...
export default function StudentDashboard() {
  ...
  return (
    <div className="flex h-screen bg-slate-50 font-sans overflow-hidden">
      ...
      {/* ======================================================== */}
      {/* YON PANEL (LEFT SIDEBAR) */}
      {/* ======================================================== */}
      <div className="w-64 bg-white border-r border-slate-200 flex flex-col flex-shrink-0 z-20 hidden md:flex">
      ...
      <div className="flex-1 h-full overflow-y-auto p-4 md:p-8">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          {/* ======================================================== */}
          {/* 4. TA'LIM SAHIFASI (Siz xohlagandek tozalangan!) */}
          {/* ======================================================== */}
          {sidebarMenu === "talim" && (
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
              ...
              {/* SIZ SO'RAGAN YAGONA MENYU (Kundalik, Jadval, Vazifa) */}
