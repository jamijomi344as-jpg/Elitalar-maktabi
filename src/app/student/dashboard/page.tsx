              ...
              <div className="animate-in fade-in duration-300">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-6 bg-white p-4 rounded-2xl border border-gray-200 shadow-sm gap-4 md:gap-0">
                  ...
                  <div className="hidden md:flex gap-2">
                    <button className="px-4 py-2 bg-white border border-gray-200 text-blue-600 font-bold text-sm rounded-lg flex items-center">
                      <Award className="w-4 h-4 mr-2"/> O'zlashTah
                    </button>
                    <button className="px-4 py-2 bg-white border border-gray-200 text-gray-400 font-bold text-sm rounded-lg">100%</button>
                  </div>
                </div>
